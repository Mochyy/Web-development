                                        ...
                                        <form class="cmxform form-horizontal style-form" id="commentForm" method="post"
                                            ...
                                            <div class="form-group ">
                                                <label for="cname" class="control-label col-lg-2">ID sản phẩm
                                                    (required)</label>
                                                <div class="col-lg-10">
                                                    <input class=" form-control" id="cname" name="id" minlength="2" value="${pro.id}"
                                                           type="text" required/>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="cemail" class="control-label col-lg-2">Tên sản phẩm
                                                    (required)</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control " id="cemail" type="text" name="name" value="${pro.name}"
                                                           required/>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control " id="curl" type="text" name="price" value="${pro.price}"/>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-10">
                                                    <select class="form-control " id="ccomment" name="category">
                                                        <c:if test="${pro.idCategory eq 'HB'}">
                                                            <option value="HB" selected >Handbag</option>
                                                            <option value="BP" >Backpack</option>
                                                            <option value="TB">Totebag</option>
                                                            <option value="CB">Crossbody</option>
                                                        </c:if>
                                                        <c:if test="${pro.idCategory eq 'BP'}">
                                                            <option value="HB" >Handbag</option>
                                                            <option value="BP" selected>Backpack</option>
                                                            <option value="TB">Totebag</option>
                                                            <option value="CB">Crossbody</option>
                                                        </c:if>
                                                        <c:if test="${pro.idCategory eq 'TB'}">
                                                            <option value="HB" >Handbag</option>
                                                            <option value="BP" >Backpack</option>
                                                            <option value="TB" selected>Totebag</option>
                                                            <option value="CB">Crossbody</option>
                                                        </c:if>
                                                        <c:if test="${pro.idCategory eq 'CB'}">
                                                            <option value="HB" >Handbag</option>
                                                            <option value="BP" >Backpack</option>
                                                            <option value="TB">Totebag</option>
                                                            <option value="CB" selected>Crossbody</option>
                                                        </c:if>
                                                            ...
                                                            <span class="btn btn-theme02 btn-file">
                                                                <span class="fileupload-new"><i class="fa fa-paperclip"></i> Chọn hình</span>
                                                                 <span class="fileupload-exists"><i
                                                                  ...
                                                                  <input type="file" class="default" name="img" value="${pro.img}"/>
                                                             </span>
